...
export default function HeroSpotlight({
  headline = "Discover Your Next Great Escape",
  subheadline = "From tropical islands to mountain trails, we design unforgettable journeys tailored to your travel style.",
  primaryCta = { label: "Start Planning", href: "#" },
  secondaryCta = { label: "Explore Destinations", href: "#" },
  ...
  return (
    <section className="relative min-h-[600px] md:min-h-[700px] flex flex-col items-center justify-center overflow-hidden rounded-md bg-background antialiased bg-grid-foreground/[0.02]">
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        <Spotlight className="top-10 left-[60%] md:left-[70%]" fill="#f59e0b" />
      </div>
